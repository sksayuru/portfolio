                ...
                <div class="p-relative container dsn-hero-parallax-title pb-60">
                    <div class="p-relative d-flex align-items-center w-100  h-100 ">
                        ...
                        <div class="box-content w-100 d-flex flex-column z-index-1">
                            ...
                            <h1 class="title-lg text-upper" data-dsn-ajax="title">ASANO <br> Website Redesign <span class="fw-200">©2022</span></h1>
                        ...
                        <div class="d-grid grid-lg-2">
                            ...
                            <div class="text pinned-scroll p-relative" data-dsn-option='{"end":"650"}'>
                                <div class=" pinned-element">
                                    ...
                                    <h3 class="title text-upper mb-30">ASANO</h3>

                                    <div class="info">
                                        <div class="info-item d-flex align-items-center border-bottom">
                                            <span class="date">Type</span>
                                            <h6 class="text-upper">Medical Website Redesign</h6>

                                        </div>

                                        <div class="info-item d-flex align-items-center border-bottom">
                                            <span class="date">Location</span>
                                            <h6 class="text-upper">Switzerland  </h6>
                                        </div>
                                        ...
                                        <div class="info-item d-flex align-items-center border-bottom">
                                            ...
                                            <h6 class="text-upper">Sayuru Karunathilaka, Isuru Karunathilaka (Development)
                                            </h6>
                                        </div>

                                    </div>

                                    <p class="mt-20">The Swiss medical platform Asano was redesigned through a contest on 
                                        99designs. The platform, which connects therapists and doctors with users 
                                        searching for medical professionals based on symptoms, was enhanced with a 
                                        focus on usability and aesthetics. A user-friendly interface was implemented, 
                                        ensuring an intuitive search system and a clear step-by-step booking process. 
                                        The design was crafted to reflect professionalism while maintaining 
                                        approachability, meeting the needs of both medical professionals and users.</p>
                                </div>
                            </div>
                            ...
                            <div class="box-img">
                                <div class="d-grid">
                                    <div class="img-item">
                                        <img class="cover-bg-img" src="assets/img/portfolio/project2/10.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="page_wrapper" class="wrapper">
                ...
                <div class="over-hidden section-margin">
                    <div class="img-box-parallax dsn-animate dsn-effect-down has-popup dsn-active"
                        ...
                        <div class="effect-popup before-z-index h-100" data-src="assets/img/portfolio/project2/5.jpg"
                            data-caption="Caption #3" data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                            <img class="cover-bg-img has-direction" src="assets/img/portfolio/project2/5.jpg" alt="">
                        </div>
                ...
                <div class="container p-relative mb-section">
                    <div class="p-relative img-box-parallax before-z-index has-popup">
                        <div class="effect-popup before-z-index h-v-80 " data-src="assets/img/portfolio/project2/3.jpg"
                            data-caption="Caption #2" data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                            <img class="cover-bg-img has-border-radius" src="assets/img/portfolio/project2/3.jpg"
                                alt="">
                        </div>
                        <div class="cap">
                            <span>Mobile Viewport Screens</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="container p-relative mb-section">
                    <div class="p-relative img-box-parallax before-z-index has-popup">
                        <div class="effect-popup before-z-index h-v-80 " data-src="assets/img/portfolio/project2/4.jpg"
                            data-caption="Caption #2" data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                            <img class="cover-bg-img has-border-radius" src="assets/img/portfolio/project2/4.jpg"
                                alt="">
                        </div>
                        <div class="cap">
                            <span>Mobile Viewport Screens</span>
                    ...
                    <div class="d-grid grid-sm-2">
                        <div class="p-relative img-box-parallax before-z-index has-popup">
                            <div class="effect-popup before-z-index "
                                data-src="assets/img/portfolio/project2/7.jpg" data-caption="Caption #2"
                                data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                                <img class="cover-bg-img has-border-radius" src="assets/img/portfolio/project2/7.jpg"
                                    alt="">
                            </div>
                            <div class="cap">
                        ...
                        <div class="p-relative img-box-parallax before-z-index has-popup">
                            <div class="effect-popup before-z-index"
                                data-src="assets/img/portfolio/project2/8.jpg" data-caption="Caption #3"
                                data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                                <img class="cover-bg-img has-border-radius" src="assets/img/portfolio/project2/8.jpg"
                                    alt="">
                            </div>
                            <div class="cap">
                                <span>Page Extras</span>
            ...
            <section class="next-projects p-relative section-padding d-flex flex-column justify-content-center">
                ...
                <div class="container p-relative">
                    <div class="box-content w-100 d-flex flex-column p-relative z-index-1">
                        ...
                        <a href="project-3.php" class="btn-arrow effect-ajax v-light background-main">
                        ...
                        <h2 class="title-lg text-upper" data-dsn-ajax="title"><a href="project-3.php"
                                class="effect-ajax">FollowUp <br> Website Design <span class="fw-200">©2025</span></a></h2>
